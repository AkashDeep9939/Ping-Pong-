document.addEventListener("DOMContentLoaded", () => {
    ...
    let dx = 2; // displacement factor in x-direction, 2 -> you will dispace by 2 px in +x direction, -2 -> you will displace in -x direction
    let dy = 2; // displacement factor in y-direction, 2-> you will displace by 2 px in +y direction, -2 -> you wi ll displace in -y direction
